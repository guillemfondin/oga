 ...
 */
final class Version20210117230927 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vote (id INT NOT NULL, agenda_id INT NOT NULL, user_id INT DEFAULT NULL, value VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
